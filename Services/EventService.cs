...
public class EventService
{
    public List<Event> Events { get; set; } = new List<Event>{
        ...
        new Event(2, "WWDC2025", "Innovations in technology", "02/15/2025", "https://images.cgames.de/images/gamestar/4/apple-event-teaser_6194070.jpg"),
        new Event(3, "Eminem Concert 2025", "If you had one shot, would you capture it? Or would you let it slip?", "03/20/2025", "https://tse1.mm.bing.net/th/id/OIP.CXSgkl1mLAFky5heyk7_wQHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3")
    };
